...
int main() {
    ...
    printf("โจทย์กำหนดให้ x = 12, y = 7, z = 12;\n\n");
    ...
    printf("    ส่วนที่สอง: (5 != (5/3)) คือ (5 != %d) ซึงคือ %d (เนื่องจาก 5/3 ใน c คือ 1)\n", (5/3), part2_expr5);
    printf("    ผลรวม: %d || คือ %d\n", !part1_expr5, part2_expr5, expression_5);
    ...
    int part1_expr7 = (x + y);
    int part2_expr7 = (z * 2);
    int expression_7 = (part2_expr7 > part2_expr7);
    printf("7. (x + y) > (z * 2)\n");
    printf("    วิธีคิด: \n");
    ...
    printf("    ส่วนที่สอง: (y %% 2 == 1) คือ (%d %% 2 == 1) ซึงคือ %d (7 หาร 2 เหลือเศษ 1 คือ True)\n", y, part2_expr8);
    ...
    printf("    ส่วนที่สอง: (z < y) คือ (%d < %d) ซึงคือ %d (12 < 7 คือ False)\n", z, y, part2_expr9);
